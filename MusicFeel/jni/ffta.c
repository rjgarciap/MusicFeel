...
void Java_android_musicfeel_ProcesadorMuestras_fht(float fz[257])
{
...
/* Does a real-valued fourier transform of "256" points of the
 ...
 void  Java_android_musicfeel_ProcesadorMuestras_realfft (JNIEnv* env,jobject this,jfloat real[257])
{
   float a,b;
   int i,j;
   Java_android_musicfeel_ProcesadorMuestras_fht(real);
